...
const CategorieItem = ({index, category}) => {
    const gradients = [
    ...
    return (
        <div
        className={`rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 cursor-pointer bg-linear-to-br ${gradients[index % gradients.length]}`} 
        >
            <div className="p-6 flex flex-col h-full">
                ...
                <button className="text-pink-500 font-bold hover:text-pink-700 transition-colors flex items-center">
                    Explore
                    <FaAngleRight />
                </button>
            </div>   
